<cfset runEvent( event= "viewlets.filterPredefinedDateRangeFuture" , private= true ) />
<cfoutput>
...
$(document).ready(function() {
	...
	<!--- TODO: Add to Model --->
	<cfset sMinDate= dateFormat( now() , "YYYY , M - 1 , D" ) />
	<cfset sMaxDate= dateFormat( dateAdd( "m" , "6" , now() )  , "YYYY , M - 1 , D" ) />
